...
import com.editor.hiderx.activity.*
...
import kotlinx.android.synthetic.main.fragment_view_pager.btn_info
import kotlinx.android.synthetic.main.fragment_view_pager.controller
import kotlinx.android.synthetic.main.fragment_view_pager.ll_delete
import kotlinx.android.synthetic.main.fragment_view_pager.ll_share
import kotlinx.android.synthetic.main.fragment_view_pager.ll_unhide
import kotlinx.android.synthetic.main.video_place_holder.*
...
class VideoPlaceHolderFragment : Fragment(),CoroutineScope by MainScope() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.video_place_holder, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        hiddenFile?.path?.let{
            val mediItem : MediaItem = MediaItem.fromUri(Uri.fromFile(File(hiddenFile?.path!!)))
            video_viewer_player_view?.player = player
            player?.prepare()
    ...
    companion object {
        ...
        fun newInstance(
            ...
            VideoPlaceHolderFragment().apply {
