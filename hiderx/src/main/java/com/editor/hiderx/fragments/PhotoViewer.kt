...
import com.editor.hiderx.adapters.ImagePagerAdapter
...
class PhotoViewer : Fragment(),OnPagerItemsClickLister {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        {
            imagePagerAdapter = ImagePagerAdapter(activity?.supportFragmentManager!!,listOfPaths!!,null,this)
        ...
        {
            imagePagerAdapter = ImagePagerAdapter(activity?.supportFragmentManager!!,null,listOfFilePaths,this)
            photo_view_pager?.adapter = imagePagerAdapter
            photo_view_pager?.currentItem = position
        }
    }
