...
public class AppProgressWheel extends View {
    private static final String TAG = AppProgressWheel.class.getSimpleName();
    ...
    public AppProgressWheel(Context context, AttributeSet attrs) {
        ...
        parseAttributes(context.obtainStyledAttributes(attrs,
                R.styleable.NNAcresProgressWheel));
    }
     ...
     * @param context
     */
    public AppProgressWheel(Context context) {
        super(context);
    }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(R.styleable.NNAcresProgressWheel_matProg_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.NNAcresProgressWheel_matProg_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.NNAcresProgressWheel_matProg_barWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.NNAcresProgressWheel_matProg_rimWidth, rimWidth);

        float baseSpinSpeed = a.getFloat(R.styleable.NNAcresProgressWheel_matProg_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(R.styleable.NNAcresProgressWheel_matProg_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.NNAcresProgressWheel_matProg_barColor, barColor);

        rimColor = a.getColor(R.styleable.NNAcresProgressWheel_matProg_rimColor, rimColor);

        linearProgress = a.getBoolean(R.styleable.NNAcresProgressWheel_matProg_linearProgress, false);

        if (a.getBoolean(R.styleable.NNAcresProgressWheel_matProg_progressIndeterminate, false)) {
            spin();
        }
