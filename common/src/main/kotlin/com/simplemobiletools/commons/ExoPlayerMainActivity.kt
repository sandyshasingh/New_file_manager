...
class ExoPlayerMainActivity : AppCompatActivity(), PlayerControlView.VisibilityListener,CoroutineScope by MainScope() {
   ...
   // val networkStream = false
    var videoList: ArrayList<ListItem>? = null
    var filesList: ArrayList<ListItem>? = null
...
//               Toasty.success(this@ExoPlayerMainActivity, mResizeTile[0]).show()
                Toast.makeText(this@ExoPlayerMainActivity, "$mResizeTile[0]", Toast.LENGTH_LONG)
                    .show()
...
//                Toasty.success(this@ExoPlayerMainActivity, mResizeTile[1]).show()
                Toast.makeText(this@ExoPlayerMainActivity, "$mResizeTile[1]", Toast.LENGTH_LONG)
                    .show()
...
//                Toasty.success(this@ExoPlayerMainActivity, mResizeTile[2]).show()
                Toast.makeText(this@ExoPlayerMainActivity, "$mResizeTile[2]", Toast.LENGTH_LONG)
                    .show()
