...
class CopyMoveTask(val activity: BaseSimpleActivity, val copyOnly: Boolean, val copyMediaOnly: Boolean, val conflictResolutions: LinkedHashMap<String, Int>,
    ...
    private val INITIAL_PROGRESS_DELAY = 200L
    private val PROGRESS_RECHECK_INTERVAL = 300L
...
//        }
        ...
        val title = activity?.getString(if (copyOnly) R.string.copying_success else R.string.moving_success)
        if(success) {
