...
class ZipFetcher(var context: Context, var fetchAudioAsyncCompleteListener: FetchZipAsyncCompleteListener,) : AsyncTask<Void, Void, ArrayList<ListItem>>() {
    ...
    override fun onPostExecute(result: ArrayList<ListItem>?) {
        ...
        fetchAudioAsyncCompleteListener.fetchZipCompleted(result)
    }
    interface FetchZipAsyncCompleteListener {
        fun fetchZipCompleted(documentsList:ArrayList<ListItem>? )
    }
